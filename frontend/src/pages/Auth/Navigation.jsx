...
const Navigation = () => {
      ...
      <div className="flex flex-col justify-center space-y">
        <Link to="/" className="flex relative">
          <div className="flex items-center transition-transform transform hover:translate-x-2">
            <AiOutlineHome
              className="mr-2 mt-[3rem] text-amber-400 hover:text-amber-300"
              size={26}
            />
        ...
        <Link to="/sell" className="flex relative">
          <div className="flex items-center transition-transform transform hover:translate-x-2">
            <AiOutlineTag
              className="mr-2 mt-[3rem] text-purple-400 hover:text-purple-300"
              size={26}
            />
        ...
        <Link to="/shop" className="flex relative">
          <div className="flex items-center transition-transform transform hover:translate-x-2">
            <AiOutlineShopping
              className="mr-2 mt-[3rem] text-blue-400 hover:text-blue-300"
              size={26}
            />
        ...
        <Link to="/cart" className="flex relative">
          <div className="flex items-center transition-transform transform hover:translate-x-2">
            <AiOutlineShoppingCart
              className="mt-[3rem] mr-2 text-amber-400 hover:text-amber-300"
              size={26}
            />
            <span className="hidden nav-item-name mt-[3rem] text-amber-100 hover:text-amber-300">
              CART
  ...
  <div className="flex items-center transition-transform transform hover:translate-x-2">
    <AiOutlineTag
      className="mr-2 mt-[3rem] text-green-400 hover:text-green-300"
      size={26}
    />
...
<Link to="/user-orders" className="flex relative">
  <div className="flex items-center transition-transform transform hover:translate-x-2">
    <AiOutlineShoppingCart
      className="mr-2 mt-[3rem] text-red-400 hover:text-red-300"
      size={26}
    />
