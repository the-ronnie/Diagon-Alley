...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f9dba3] via-[#ff8b74] to-[#6dc4e7] relative overflow-hidden flex items-center justify-center p-4">
      {/* Beach and Magic elements */}
      <div className="absolute inset-0 w-full h-full">
        {/* Subtle animated ocean waves */}
        <div className="absolute top-10 left-0 right-0 bottom-0 bg-gradient-to-b from-transparent to-[#2a3c56] animate-wave opacity-30" />
      ...
      <div className="w-full max-w-md relative">
        <div className="bg-[#ffffff]/30 backdrop-blur-lg rounded-xl p-8 shadow-2xl border border-amber-500/20 relative">
          {/* Magical glow effect */}
          ...
          <div className="relative">
            <div className="flex flex-col items-center gap-3 mb-8">
              ...
              <h1 className="text-2xl font-serif font-semibold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                Diagon Alley
              </h1>
              <p className="text-amber-100/60 text-sm text-center font-serif">Where Waves Meet Wonders</p>
            </div>
